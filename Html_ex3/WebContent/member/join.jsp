				...
				<table class="login_table">
					...
					<tr>
						...
						<td><input type="password" placeholder="PW를 다시 입력하세요."
							name="pw2" size="60" style="color: #60ae2b"></td>
					</tr>
					<tr>
						<td>NAME :</td>
				...
				<table class="gender">
					...
					<tr>
						<td><input type="radio" checked="checked" name="gender"
							id="btn"></td>
						<td><input type="radio" name="gender" id="btn"></td>
					</tr>
				</table>
				<table class="login_table">
					<tr>
						<td>PHONE :</td>
						<td><input type="" placeholder="PHONE NUMBER를 입력하세요."
							name="phone" size="60" style="color: #60ae2b"></td>
					</tr>
					<tr>
						<td>E-MAIL :</td>
						<td><input type="email" placeholder="E-MAIL를 입력하세요."
							name="name" size="60" style="color: #60ae2b"></td>
					</tr>
				</table>
