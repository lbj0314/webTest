...
<header>
	...
	<section id="notice_main2">
		...
		<div class="noticeinfo2">
			<h1 align="center" style="color: #60ae2b">글 수정하기</h1>
	<form action="./qnaList.html" method="get">
		<table >
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="content" value="ShakeShark의 Q&A 제목" size="60" style="color: #60ae2b"></td>
			</tr>
			<tr>
				<td style="color: #60ae2b">내용 :</td>
				<td><textarea rows="30" cols="55" style="color: #60ae2b">
ShakeShack의 Q&A 내용
ShakeShack의 Q&A 내용
</textarea></td>
			...
			<div class="noticewrite">
				<div class="nw1">
					<a href="./qnaListOne.jsp">뒤로 가기</a>
				</div>
				<div class="nw1">
					<a href="./qnaList.jsp">수정하기</a>
				</div>
			</div>
		</div>
	</section>
