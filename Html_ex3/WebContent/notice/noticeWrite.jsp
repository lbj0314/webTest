...
<body>
	...
	<section id="notice_main2">
		...
		<div class="noticeinfo2">
			<h1 align="center" style="color: #60ae2b">공지사항 쓰기</h1><br>
	<form action="./noticeList.html" method="get">
		<table >
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="content" size="60" style="color: #60ae2b"></td>
			</tr>
			<tr>
				<td style="color: #60ae2b">내용 :</td>
				<td><textarea rows="30" cols="55" style="color: #60ae2b"></textarea></td>
