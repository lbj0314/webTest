...
<body>
	...
	<section id="notice_main2">
		...
		<div class="noticeinfo2">
			<h1 align="center" style="color: #60ae2b">공지사항 수정</h1><br>
	<form action="./noticeList.jsp" method="get">
		<table >
			<tr>
				<td class="tw1" style="color: #60ae2b">작성자 :</td>
				<td class="tw2" style="color: #60ae2b"><input type="text" value="로그인한 ID 이름" name="name"
					disabled="disabled" size="60" style="color: #60ae2b"></td>
			</tr>
			<tr>
				<td style="color: #60ae2b">제목 :</td>
				<td><input type="text" name="content" value="ShakeShark의 공지사항" size="60" style="color: #60ae2b"></td>
			</tr>
			<tr>
				<td style="color: #60ae2b">내용 :</td>
				<td><textarea rows="30" cols="55" style="color: #60ae2b">ShakeShark의 공지사항 내용</textarea></td>
			...
			<div class="noticewrite">
				<div class="nw1">
					<a href="./noticeListOne.jsp">뒤로 가기</a>
				</div>
				<div class="nw1">
					<a href="./noticeList.jsp">수정하기</a>
				</div>
			</div>
		</div>
	</section>
