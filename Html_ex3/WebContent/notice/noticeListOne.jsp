...
<body>
	...
	<section id="notice_main2">
		<div class="main_sub">
			<img id="visual" alt="#" src="/Html_ex3/imgs/common/main_visual3.jpg">
		</div>
		<div class="noticeinfo2">
			<h1 align="center" style="color: #60ae2b">공지사항</h1><br>
	<form action="./noticeList.jsp" method="get">
		<table >
			<tr>
				<td class="tw1" style="color: #60ae2b">작성자 :</td>
				<td class="tw2"><input type="text" value="로그인한 ID 이름" name="name"
					disabled="disabled" size="60" style="color: #60ae2b"></td>
			</tr>
			<tr>
				<td style="color: #60ae2b">제목 :</td>
				<td><input type="text" name="content" value="ShakeShark의 공지사항" size="60" disabled="disabled" style="color: #60ae2b"></td>
			</tr>
			<tr>
				<td style="color: #60ae2b" >내용 :</td>
				<td><textarea rows="30" cols="55" disabled="disabled" style="color: #60ae2b">ShakeShark의 공지사항 내용</textarea></td>
			...
			<div class="noticewrite">
				<div class="nw1">
					<a href="./noticeList.jsp">뒤로 가기</a>
				</div>
				<div class="nw1">
					<a href="./noticeUpdate.jsp">글 수정</a>
				</div>
			</div>
		</div>
	</section>
