...
<header>
	...
	<section id="notice_main">
		...
		<div class="noticeinfo">
			<h1 align="center" style="color: #60ae2b">NOTICE</h1><br>
			<table class="notice_table">
				<tr style="background-color: #60ae2b;">
					<td class="tno">No.</td>
					<td class="ttitle">TITLE</td>
					<td class="tdate">DATE</td>
				</tr>
				<tr style="color:#60ae2b;">
					<td>10</td>
					<td><a href="./noticeListOne.jsp">ShakeShack의 공지사항 제목</a></td>
					<td>2019. 10. 21</td>
			...
			<div class="noticewrite">
				<div class="nw1">
					<a href="/Html_ex3/index.jsp">MAIN</a>
				</div>
				<div class="nw1">
