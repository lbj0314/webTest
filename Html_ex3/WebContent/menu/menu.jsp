...
<header>
	...
	<section id="menu_main">
		<div class="main_sub">
			<img id="visual" alt="#" src="/Html_ex3/imgs/common/main_visual5.jpg">
		</div>
		<div class="menuinfo">
			<p class="menutit">
				<img alt="#" src="../imgs/common/tit_menu.png">
			</p>
			<br> <img alt="#" src="../imgs/common/menu1.jpg"><br>
			<img alt="#" src="../imgs/common/menu2.jpg">
		</div>
		<div class="btn">
			<ul>
				<li><a href="http://www.shakeshack.kr/pdf/gangnam_191001.pdf"><img
						id="menuimg" alt="전체 메뉴" src="../imgs/common/view_btn.png"></a>
					<p>전체 메뉴 보기</p></li>
			</ul>
		</div>
	</section>
